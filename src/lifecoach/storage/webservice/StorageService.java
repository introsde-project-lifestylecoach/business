 ...
 * 
 */
@WebServiceClient(name = "StorageService", targetNamespace = "http://webservice.storage.lifecoach/", wsdlLocation = "http://localhost:6902/ws/storage?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:6902/ws/storage?wsdl");
